...
export default function App() {
  ...
  return (
    <>
      <Navbar>
        <Search>
          <NumResults animes={animes} query="" />
        </Search>
      </Navbar>
...
function NumResults({ animes, query }) {
  ...
  return (
    <p className="search-results">
      Found <strong>{filteredAnimes.length}</strong> results
    </p>
  );
}
...
function Main({ children }) {
  return (
    <main className="main">
      {children}
      {/* <ListBox animes={animes} handleSelectedAnime={handleSelectedAnime} />
